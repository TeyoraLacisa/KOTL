...
/// <summary>
/// Полная система инвентаря с HUD
/// Добавьте этот скрипт на пустой GameObject
/// </summary>
public class CompleteInventoryHUD : MonoBehaviour
{
    [Header("HUD Settings")]
    ...
    public static CompleteInventoryHUD Instance { get; private set; }
    ...
    void CreateHUD()
    {
        ...
        Debug.Log("✅ Полная система инвентаря с HUD создана!");
    }
    ...
    void AddStartingItems()
    {
        ...
        InventoryItem diary = new InventoryItem("Дневник", diaryIcon, "Старый потрепанный дневник", true);
        InventoryItem lighter = new InventoryItem("Зажигалка", lighterIcon, "Металлическая зажигалка", true);
        InventoryItem key = new InventoryItem("Ключ", keyIcon, "Ржавый ключ", true);
        ...
        Debug.Log("✅ Стартовые предметы добавлены в инвентарь!");
    }
    ...
    void Update()
    {
        ...
        // Тестовые предметы
        if (Input.GetKeyDown(KeyCode.Q)) AddItem(new InventoryItem("Тест1", CreateColoredIcon(Color.red), "Тестовый предмет 1", true));
        if (Input.GetKeyDown(KeyCode.W)) AddItem(new InventoryItem("Тест2", CreateColoredIcon(Color.green), "Тестовый предмет 2", true));
        if (Input.GetKeyDown(KeyCode.E)) AddItem(new InventoryItem("Тест3", CreateColoredIcon(Color.blue), "Тестовый предмет 3", true));
    }
